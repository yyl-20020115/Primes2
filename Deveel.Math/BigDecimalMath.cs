...
{
    public static BigDecimal Abs(this BigDecimal a) => a >= 0 ? a : -a;
    ...
    public static BigDecimal Divide(this BigDecimal dividend, BigDecimal divisor)
    {
    ...
    public static BigDecimal Divide(this BigDecimal dividend, BigDecimal divisor, MathContext mc)
    {
 ...
 */
    ...
    public static BigDecimal Sqrt(this BigDecimal value)
    {
        ...
        //var x = n.Divide(BigDecimal.Two, MathContext.Decimal128);
        //while (x.Subtract(x = SqrtIteration(x, n)).Abs().CompareTo(BigDecimal.Zero) > 0) ;
        //return x;
    }
